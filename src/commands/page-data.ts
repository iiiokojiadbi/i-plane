...
export const projectOfPage = async (client: PlaneClient, ref: string): Promise<Project> => {
...
export const pagesOf = (client: PlaneClient, projectId: string): Promise<ReadonlyArray<Page>> =>
